...
Refer to README.md for tech details and building.

Refer to these instructions for avoiding mistakes when working here:
- Styling
  - Use Tailwind canonical classes
...
- Do not run a build or generate after each iteration
